...
export const messages = {
  th: {
    ...
    inviteLinkCreated: "สร้างลิงก์เชิญแล้ว",
    copyInviteLink: "คัดลอกลิงก์",
    closeModal: "ปิด",
    resetPassword: "รีเซ็ตรหัสผ่าน",
    resetPasswordFor: "รีเซ็ตรหัสผ่านสำหรับ",
    ...
    filterNeedsAdmin: "ต้องการแอดมิน",
    ...
    auditLogsTab: "บันทึกการใช้งาน",
    auditLogsTitle: "บันทึกการใช้งาน (Audit Log)",
    auditLogsSubtitle: "ติดตามการเข้าสู่ระบบ การตั้งค่า AI และการดำเนินการสำคัญ — ไม่สามารถลบหรือแก้ไขได้",
    auditLogsExport: "ส่งออก CSV",
    auditLogsRange: "ช่วงเวลา",
    auditLogsRange7d: "7 วัน",
    auditLogsRange30d: "30 วัน",
    auditLogsRange90d: "90 วัน",
    auditLogsCategory: "หมวด",
    auditLogsCategoryAll: "ทุกหมวด",
    auditLogsColTime: "เวลา",
    auditLogsColActor: "ผู้ดำเนินการ",
    auditLogsColAction: "การกระทำ",
    auditLogsColTarget: "เป้าหมาย",
    auditLogsColDetails: "รายละเอียด",
    auditLogsSystemActor: "ระบบ",
    auditLogsEmpty: "ไม่พบบันทึกในช่วงที่เลือก",
    auditLogsLoadError: "โหลดบันทึกการใช้งานไม่สำเร็จ",
    auditLogsExportError: "ส่งออก CSV ไม่สำเร็จ",
    auditLogsPrev: "ก่อนหน้า",
    auditLogsNext: "ถัดไป",
    auditLogsPagination: "หน้า {{page}} / {{totalPages}} · ทั้งหมด {{total}} รายการ",
    ...
    summaryTitle: "สรุปบทสนทนา (AI)",
    summaryPlaceholder: "สรุปประเด็นหลักและความต้องการของลูกค้าอย่างรวดเร็วด้วย AI",
    startSummary: "✨ เริ่มการสรุปบทสนทนา",
    updatingSummary: "⏳ กำลังอัปเดต...",
    reSummary: "🔄 สรุปใหม่อีกครั้ง",
    summaryGenerating: "⏳ กำลังสรุป...",
    summaryRateLimit: "ใช้ AI สรุปบ่อยเกินไป รอสักครู่แล้วลองใหม่",
    aiCreditCostHint: "🤖 การปรับแต่งน้ำเสียงจะใช้ 1 เครดิต AI",
    toneRefineHeader: "🤖 ปรับแก้น้ำเสียง:",
    rewriteBtn: "✍️ เขียนใหม่",
    shorterBtn: "⚡ ย่อความ",
    politeBtn: "🤝 สุภาพ",
    friendlyBtn: "😊 เป็นกันเอง",
    dismissBtn: "❌ ปฏิเสธ",
    summaryFailed: "สรุปบทสนทนาล้มเหลว",
    ...
    aiPolicyBlockedTopics: "หัวข้อที่ AI ห้ามพูด (คั่นด้วย comma)",
    aiPolicyBlockedTopicsHint:
      "ถ้าข้อความตอบของ AI มีคำเหล่านี้ ระบบจะไม่ส่ง — บันทึกร่างและส่งต่อแอดมิน",
    aiGuardrailNotice:
      "AI ตอบอัตโนมัติถูกปิดโดย guardrail เนื่องจากคะแนน QA ต่ำต่อเนื่อง — เปิดใช้งานใหม่ด้วย toggle ด้านบน",
  ...
  en: {
    ...
    auditLogsTab: "Audit log",
    auditLogsTitle: "Audit log",
    auditLogsSubtitle: "Immutable trace of logins, AI actions, and critical settings changes.",
    auditLogsExport: "Export CSV",
    auditLogsRange: "Date range",
    auditLogsRange7d: "7 days",
    auditLogsRange30d: "30 days",
    auditLogsRange90d: "90 days",
    auditLogsCategory: "Category",
    auditLogsCategoryAll: "All categories",
    auditLogsColTime: "Time",
    auditLogsColActor: "Actor",
    auditLogsColAction: "Action",
    auditLogsColTarget: "Target",
    auditLogsColDetails: "Details",
    auditLogsSystemActor: "System",
    auditLogsEmpty: "No audit entries in this range",
    auditLogsLoadError: "Failed to load audit logs",
    auditLogsExportError: "Failed to export CSV",
    auditLogsPrev: "Previous",
    auditLogsNext: "Next",
    auditLogsPagination: "Page {{page}} / {{totalPages}} · {{total}} entries",
    ...
    summaryTitle: "Chat Summary (AI)",
    summaryPlaceholder: "Quickly summarize key points and customer needs with AI",
    startSummary: "✨ Start Summarization",
    updatingSummary: "⏳ Updating...",
    reSummary: "🔄 Re-summarize",
    summaryGenerating: "⏳ Summarizing...",
    summaryRateLimit: "Summarizing too frequently. Please wait.",
    aiCreditCostHint: "🤖 Tone adjustments consume 1 AI credit",
    toneRefineHeader: "🤖 Refine tone:",
    rewriteBtn: "✍️ Rewrite",
    shorterBtn: "⚡ Shorter",
    politeBtn: "🤝 Polite",
    friendlyBtn: "😊 Friendly",
    dismissBtn: "❌ Dismiss",
    summaryFailed: "Conversation summary failed",
    ...
    aiPolicyBlockedTopics: "Blocked reply topics (comma-separated)",
    aiPolicyBlockedTopicsHint:
      "If the AI reply contains these phrases, it will not be sent — draft saved and escalated.",
    aiGuardrailNotice:
      "AI auto-reply was disabled by guardrail due to sustained low QA scores — re-enable with the toggle above.",
